...
export const scheduleDays = [
  {
    ...
    items: [
      ...
      ['11:00', '破冰及午餐', 'fun'],
      ['13:00', 'Go 基礎語法', 'class'],
      ['15:00', 'Function', 'class'],
      ['16:00', 'Git / GitHub', 'class'],
      ['17:30', '晚餐', 'soft'],
      ['18:30', '遊戲', 'fun'],
    ],
  },
  {
    ...
    week: '週五',
    items: [
      ['09:00', 'Go：Struct', 'class'],
      ['10:00', 'Go：Slice & Map', 'class'],
      ['11:00', '網路基礎概論', 'class'],
      ['12:00', '午餐', 'soft'],
      ['15:30', 'TG Bot 接收訊息', 'class'],
      ['16:30', 'Command Handler', 'class'],
      ['17:00', 'Bot 功能實作', 'class'],
      ['18:00', '晚餐', 'soft'],
      ['19:00', '晚會', 'fun'],
    ],
  },
  {
    ...
    week: '週六',
    items: [
      ['09:00', 'Command System', 'class'],
      ['09:30', '外部 API', 'class'],
      ['10:00', 'JSON Parsing 實戰', 'class'],
      ['10:30', '小功能實作', 'class'],
      ['12:00', '午餐', 'soft'],
      ['15:00', '狀態管理', 'class'],
      ['15:30', '錯誤處理 & Debug', 'class'],
      ['16:00', '專案架構', 'class'],
      ['16:30', 'Docker / Deploy', 'class'],
      ['17:00', '黑客松開幕 + 晚餐', 'hack'],
    ],
  },
  {
