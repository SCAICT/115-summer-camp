...
export default function Footer() {
  return (
    <footer id="報名" className="section-unified-bg relative w-full overflow-hidden border-t border-paper/10 pb-8 pt-20 sm:pt-24">
      ...
      <div className="section-shell">
        <div className="mb-9 grid gap-8 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr]">
          <div>
            ...
            <div className="mb-5 font-mono text-[11px] tracking-[0.2em] text-paper/50">SCAICT × NCHU · SUMMER CAMP 2026</div>
            <p className="max-w-xs text-sm leading-7 text-paper/60">夏夜，星光，與你的第一個 Bot。</p>
          </div>
