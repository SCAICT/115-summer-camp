...
function Hero() {
  ...
  return (
    <section className="relative min-h-[720px] overflow-x-clip overflow-y-visible text-paper lg:h-screen">
      ...
      <div className="responsive-orb pointer-events-none absolute bottom-[-14rem] right-[-24vw] h-[560px] w-[560px] rounded-full bg-[radial-gradient(circle,#d97a9a_0%,#8b6f9e_42%,transparent_76%)] opacity-22 blur-[95px] sm:bottom-[-17rem] sm:right-[-8vw] sm:h-[680px] sm:w-[min(680px,85vw)] sm:opacity-26 sm:blur-[105px]" />
